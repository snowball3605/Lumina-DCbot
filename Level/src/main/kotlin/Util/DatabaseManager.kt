...
import com.onmi_tech.Connection
import com.onmi_tech.database_link
import java.sql.DriverManager

fun init() {
    DriverManager.getConnection(database_link).use {
...
fun write(MySQl: String): Boolean {
    val preparedStatement = Connection?.prepareStatement(MySQl)
